...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm">
            <form method="post" action="index.php?controller=lesson&action=update" class = "m-5 mt-2">
                <input type="hidden" name="id" value="<?php echo $id; ?>">

                <label class="input-group-text" for="title">Course_ID:</label>
                <input class="form-control" type="text" name="course_id" id="title" value="<?php echo $cour_id; ?>" required>
